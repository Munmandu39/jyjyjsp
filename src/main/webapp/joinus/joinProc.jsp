...
//에러체크 id가 null인지, 패스워드가 일치하지 않은지
List<String> errors=new ArrayList();
if(id==null || id.equals("")){ //id를 입력하지 않을 상태
	errors.add("아이디없음");
}
...
if(errors.size()>0){ //에러가 존재한다면
	//errors를 가지고(request에 담아서) join.jsp로 감
	request.setAttribute("errors", errors); //"errors"라는 이름으로 errors를 보냄
